...
{
	/**
	 * The Entity's parent, all values not specified in the .ent file of this Entity will be taken from the parent's .ent file 
	 */
     ...
     * 2 gameSolid (only object marked as gamePlay objects will collide with the object (players, projectiles, etc.) but not particles etc.) <br>
	...
	/**
	 * This method is called every game-tick to make the Entity perform whatever it does
	 */
	public void onTick()
	{
	}
	...
	/**
	 * This method takes a HashMap<String, Object> and tranfers it's content to the Entity's 'customValues'
	 * @param map A HashMap containing the custom values
	 */	
