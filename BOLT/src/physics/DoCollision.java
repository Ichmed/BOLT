...
import physics.collisionObjects.CollisionSphere;
...
public abstract class DoCollision
{
	...
	public static Vector3f measureSpherePenetration(CollisionSphere sphere1, CollisionSphere sphere2)
	{
		...
		if (tempLength - (sphere1.radius + sphere2.radius) >= 0) return new Vector3f(0, 0, 0);
		// else put distance to the length of the real surface distance of the
		// Spheres
		dist.normalise();
	...
	public static void correctSpherePenetration(CollisionSphere sphere1, CollisionSphere sphere2)
	{
		...
		if (sphere1.mass == 0) sphere2.middle.translate(penetration.x, penetration.y, penetration.z);
		else if (sphere2.mass == 0) sphere1.middle.translate(penetration.x, penetration.y, penetration.z);
		else
		{
