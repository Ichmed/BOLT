...
public class CollisionBox extends CollisionObject
{
	...
	public static CollisionBox createCollisionBox(Vector3f... points)
	{
		...
		// from: x-axis is right-left-axis, y-axis is front-back-axis, z-axis is
		// height-axis
		// to: x-axis is right-left-axis, y-axis is height-axis, z-axis is
		// front-back-axis
		...
		// Rotating Planes around the object to a max value of 180� where the
		...
		for (int degree = 1; degree < 180; degree++)
		{
			...
			//
			// Rotating frontPlane and transforming it to the standard
			// (HesseNormalForm)
			//
			...
			front.transformToHesseNormalForm();
			//
			// Rotating backPlane and transforming it to the standard
			// (HesseNormalForm)
			//
			...
			// setting the round-best-Values (for the next rotation as
			// compareValues)
		...
		float minDistanceLeftRight = Float.MAX_VALUE;
		Vector3f normalLeft = MathHelper.cloneVector(bestNormalLeft);
		// working values for Planes and distances
		float distanceLeftRight = 0;
		...
		for (int degree = 0; degree < 180; degree++)
		{
			...
			//
			// Rotating leftPlane and transforming it to the standard
			// (HesseNormalForm)
			//
			...
			left.transformToHesseNormalForm();
			//
			// Rotating rightPlane and transforming it to the standard
			// (HesseNormalForm)
			//
